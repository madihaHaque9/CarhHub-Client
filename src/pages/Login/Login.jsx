    ...
    <div className='flex justify-center items-center min-h-screen bg-gray-100 bg-cover bg-center' style={{backgroundImage: `url(${img})`}} >
      <div className='flex flex-col max-w-md p-6 rounded-md sm:p-10  text-black'>
          ...
          <div className='space-y-4'>
            <div>
              ...
              <input
                ...
                className='w-full px-3 py-2 border rounded-md border-gray-300 focus:outline-gray-500 bg-gray-200 text-black'
        ...
        <div className='space-y-1'>
          <Link
            to='/forgot-password'
            className='text-xs hover:underline hover:text-gray-500 text-black'
          >
            Forgot password?
          </Link>
        </div>
        ...
        <p className='px-6 text-sm text-center text-white'>
          ...
          <Link
            to='/signup'
            className='hover:underline hover:text-white text-white'
          >
            Sign up
          </Link>
        </p>
